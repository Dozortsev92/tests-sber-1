...
import { IIcon } from 'ts-types/components';

const EyeIcon: React.FC<IIcon> = ({ width, height }) => {
	return (
		<svg width={width} height={height} version="1.1" viewBox="0 0 512 512" enableBackground="new 0 0 512 512">
			<g>
